...
[![GoDoc](https://godoc.org/github.com/gesemaya/sniper?status.svg)](https://godoc.org/github.com/gesemaya/sniper)
...
```bash
go get -u github.com/gesemaya/sniper
```
...
[here](https://godoc.org/github.com/gesemaya/sniper#pkg-constants).
...
implementations:
```go
import "github.com/gesemaya/sniper/middleware"
```
...
[here](https://pkg.go.dev/github.com/gesemaya/sniper#Option).
