...
[![GoDoc](https://godoc.org/github.com/gesemaya/tele?status.svg)](https://godoc.org/github.com/gesemaya/tele)
...
```bash
go get -u github.com/gesemaya/tele
```
...
[here](https://godoc.org/github.com/gesemaya/tele#pkg-constants).
...
implementations:
```go
import "github.com/gesemaya/tele/middleware"
```
...
[here](https://pkg.go.dev/github.com/gesemaya/tele#Option).
